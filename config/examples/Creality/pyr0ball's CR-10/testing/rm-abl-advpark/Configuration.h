...
#define STRING_CONFIG_H_AUTHOR "(pyr0ball, SKR mini E3 DIP w/ TMC2130 + EasyPiezi)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Pyr0ball's Custom CR-10
  #define DEFAULT_Kp 198.47
  #define DEFAULT_Ki 27.82
  #define DEFAULT_Kd 944.05
...
//#define MIN_BED_POWER 90
  //#define PID_BED_DEBUG // Sends debug data to the serial port.

  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
  #define DEFAULT_bedKp 198.47
  #define DEFAULT_bedKi 27.82
  #define DEFAULT_bedKd 944.05
